...
module.exports = function( passport, jwtTokenizer ) {
  ...
  router.get( '/', checkMobile, function( req, res ) {
    if( req.isMobile ) {
      res.render( 'm_index' );
    } else {
      res.render( 'index' );
  ...
  router.get( '/@:room', checkMobile, function( req, res ) {
    var roomId = req.params.room;
    if( req.isMobile ) {
      res.render( 'm_room', { room: roomId } );
    } else {
  ...
  router.get( '/login', checkMobile, function( req, res ) {
    if( req.isMobile ) {
      res.render( 'm_login' );
    } else {
      res.render( 'login' );
  ...
  router.get( '/signup', checkMobile, function( req, res ) {
    if( req.isMobile ) {
      res.render( 'm_signup' );
    } else {
      res.render( 'signup' );
