(function() {
  ...
  /* Run */
  app.run( [ '$window', 'tokenManager', 'auth', '$rootScope',
      function( $window, tokenManager, auth, $rootScope ) {

    /* Create rootscope (global) variable that says if it is mobile */
    ...
    tokenManager.loadUserCredentials( function() {
      ...
      auth.getUser( null, null, function() {
        ...
        if( $window.location.pathname == '/home' ) {
          ...
          /* // TODO if we create the '/home' page, it should eventually check if 
             // authenticated status before redirecting 
            if( !auth.isAuthenticated() ) {
              $window.location.href = '/';
            }
          */
